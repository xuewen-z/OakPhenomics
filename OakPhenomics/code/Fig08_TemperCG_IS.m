...
%% Que --- LU
load([Path_CGPHE2TMN,'CGPHE2TMN_A20092020.mat']);

YearCode = {'2009','2010','2011','2012','2013','2014','2015','2016','2017','2018','2019'};
...
xlabel(['Mean spring Ta of provenance origin (°C) '],'FontWeight','bold','Fontname','Times New Roman','Fontsize',20);
...
print(Fig,'-dtiff','-r300',[Path_Figure,'LUQueCGTmn1.tif']);close(Fig);
...
xlabel(['Mean autumn Ta of provenance origin (°C) '],'FontWeight','bold','Fontname','Times New Roman','Fontsize',20);
...
print(Fig,'-dtiff','-r300',[Path_Figure,'LCQueCGTmn1.tif']);close(Fig);
...
xlabel(['Mean annual Ta of provenance origin (°C)'],'FontWeight','bold','Fontname','Times New Roman','Fontsize',20);
...
print(Fig,'-dtiff','-r300',[Path_Figure,'GSLQueCGTmn1.tif']);close(Fig);
